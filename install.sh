#!/usr/bin/env sh
# Universal installer for adsbwatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/adsbwatch.git"
echo "Installing adsbwatch ..."
